...
class SaleAdvancePaymentInv(models.TransientModel):
	...
	def _create_invoices(self, sale_orders):
		...
		_logger.info(f'\n👉 SaleAdvancePaymentInv._create_invoices:: invoices {invoices}')
		# Jeżeli to zaliczka
...
class SaleOrder(models.Model):
	...
	def _create_invoices(self, grouped=False, final=False):
		...
		for order in self:
			...
			_logger.info(f'\n👉 SaleOrder._create_invoices:: related_moves = {related_moves} ; zal_exists = {zal_exists}') 
...
class AccountMoveKsef(models.Model):
	...
	def action_create_ksef_correction(self):
		...
		#wizard.modify_moves() # DLA ODOO 18
		wizard.reverse_moves() # DLA ODOO 16
